import { defaultLang, routes, showDefaultLang, ui } from "@/i18n/ui"
...
export function dynamicTranslate(t: string, placeholders: Record<string, string | number>) {
	let translation = t
	for (const placeholder in placeholders) {
		translation = translation.replace(`{${placeholder}}`, placeholders[placeholder] as string)
	}
	return translation
}
